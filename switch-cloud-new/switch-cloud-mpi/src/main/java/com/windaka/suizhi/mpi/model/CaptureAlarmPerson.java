...
public class CaptureAlarmPerson {
    ...
    public String getDetailPersonCode() {
        return detailPersonCode;
    }

    public void setDetailPersonCode(String detailPersonCode) {
        this.detailPersonCode = detailPersonCode == null ? null : detailPersonCode.trim();
    }
    ...
    public void setDetailPersonName(String detailPersonName) {
        this.detailPersonName = detailPersonName == null ? null : detailPersonName.trim();
    }

    public String getDetailPersonPaperNum() {
        return detailPersonPaperNum;
    }

    public void setDetailPersonPaperNum(String detailPersonPaperNum) {
        this.detailPersonPaperNum = detailPersonPaperNum == null ? null : detailPersonPaperNum.trim();
    }

    public String getDetailPersonPhone() {
        return detailPersonPhone;
    }

    public void setDetailPersonPhone(String detailPersonPhone) {
        this.detailPersonPhone = detailPersonPhone == null ? null : detailPersonPhone.trim();
    }
    ...
    public void setContrastValue(String contrastValue) {
        this.contrastValue = contrastValue == null ? null : contrastValue.trim();
    }
