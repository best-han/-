 ...
 */
package com.windaka.suizhi.user.util;
...
public class Paginator<T> implements java.io.Serializable {
    ...
    public static HashMap<String, Integer> getPageNumPageSize(HttpServletRequest request, int defaultPageNum, int defaultPageSize) {
        int pageNum = request.getParameter("page") == null ? defaultPageNum : Integer.parseInt(request.getParameter(
                "page"));
        int pageSize = request.getParameter("limit") == null ? defaultPageSize : Integer.parseInt(request.getParameter(
                "limit"));
