...
@Slf4j
@RestController
public class FaceGroupPersonServiceImpl implements FaceGroupPersonService {
    @Autowired
    private FaceGroupPersonDao faceGroupPersonDao;
    @Autowired
    ...
    @Override
    public void saveFaceGroupPerson(Map<String, Object> params) throws OssRenderException {
        ...
        /*    FileUploadUtil.inputStreamToLocalFile(picByte, CommonConstants.LOCAL_PROJECT_IMAGE_PATH, fileName);
            ...
            //params.put("faceGroupPersonId",faceGroupPersonId);
            faceGroupPersonDao.saveFaceGroupPerson(params);
            if(params.get("personPaperNum") !=null || params.get("personPaperNum") !=""){
                personDao.updatePersonFacePersonGroupIdByPaperNum(params.get("personPaperNum").toString());
            }
        }
    ...
    @Transactional(rollbackFor = Exception.class)
    @Override
    public void delFaceGroupPerson(Map<String, Object> params) throws OssRenderException {
...
//        }
//        faceGroupPersonDao.delFaceGroupPerson(params);撤控
        faceGroupPersonDao.deletFaceGroupPerson(params);//彻底删除
        //调用人脸特征删除
        FaceContrastUtil.delFace(Integer.parseInt(params.get("id").toString()));
    }

    @Override
    public Map<String, Object> faceFaceGroupList(Map<String, Object> params) throws OssRenderException {

        Map<String, Object> map = new HashMap<String, Object>();

        //int totalRows = faceGroupPersonDao.faceFaceGroupListTotal(params);
        List<Map<String, Object>> lists = faceGroupPersonDao.faceFaceGroupList(params);
        if(lists.size()>0){
